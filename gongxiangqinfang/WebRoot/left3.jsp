...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd><a href="doUpdatePutongyonghu2.do" target="rightFrame">个人资料管理</a></dd>
		</dl>
		...
		<dl class="custom">
		 ...
		 <dl class="channel">
			<dt onClick="changeImage()">我的预约记录<img src="images/left/select_xl01.png"></dt>
			<dd><a href="yuyuejiluList2.do" target="rightFrame">我的预约记录</a></dd>
		</dl>
