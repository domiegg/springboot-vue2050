...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd><a href="qinfangzhuList.do" target="rightFrame">琴房主管理</a></dd>
			<dd><a href="putongyonghuList.do" target="rightFrame">普通用户管理</a></dd>
		...
		<dl class="custom">
			...
			<dd><a href="xinwentongzhiList.do?lb=站内新闻" target="rightFrame">站内新闻管理</a></dd>
			<dd class="first_dd"><a href="xinwentongzhi_add.jsp?lb=通知公告" target="rightFrame">通知公告添加</a></dd>
			<dd><a href="xinwentongzhiList.do?lb=通知公告" target="rightFrame">通知公告管理</a></dd>

		</dl>
		<dl class="channel">
			<dt onClick="changeImage()">共享琴房管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="qinfangxinxiList.do" target="rightFrame">共享琴房管理</a></dd>
			<dd><a href="yuyuejiluList.do" target="rightFrame">预约记录管理</a></dd>
		</dl>
	
		<%-- <dl class="app">
			<dt onClick="changeImage()">精彩视频管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="xinwentongzhi_add.jsp?lb=精彩视频" target="rightFrame">精彩视频添加</a></dd>
			<dd><a href="xinwentongzhiList.do?lb=精彩视频" target="rightFrame">精彩视频管理</a></dd>
		</dl> --%>
	
		<dl class="cloud">
			<dt onClick="changeImage()">互动论坛管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="bankuai_add.jsp" target="rightFrame">论坛版块添加</a></dd>
			<dd><a href="bankuaiList.do" target="rightFrame">论坛版块管理</a></dd>
			<dd><a href="tieziList.do" target="rightFrame">论坛帖子管理</a></dd>
		</dl>
		...
		<%-- <dl class="syetem_management">
			...
			<dd><a href="xinwentongzhiList.do" target="rightFrame">站内新闻管理</a></dd>
		</dl> --%>
