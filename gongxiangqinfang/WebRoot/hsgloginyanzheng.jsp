...
<html>
 ...
 if(cx.equals("普通用户")){sql="select * from putongyonghu where yonghuming='"+uid+"' and mima='"+pwd+"'";} if(cx.equals("琴房主")){sql="select * from qinfangzhu where yonghuming='"+uid+"' and mima='"+pwd+"'";} //quxanxiaxndexnglxu
