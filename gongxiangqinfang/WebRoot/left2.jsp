...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd><a href="doUpdateQinfangzhu2.do" target="rightFrame">个人资料管理</a></dd>
		</dl>
	
		<dl class="custom">
			<dt onClick="changeImage()">我的帖子管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="tieziList2.do" target="rightFrame">我的帖子管理</a></dd>

		</dl>
	
		 <dl class="channel">
			<dt onClick="changeImage()">共享琴房管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="qinfangxinxi_add.jsp" target="rightFrame">共享琴房添加</a></dd>
			<dd><a href="qinfangxinxiList2.do" target="rightFrame">我的共享琴房</a></dd>
			<dd><a href="yuyuejiluList3.do" target="rightFrame">预约记录管理</a></dd>
		</dl>
		...
		<%--<dl class="app">
			...
			<dd><a href="xinwentongzhiList.do" target="rightFrame">站内新闻添加</a></dd>
		</dl>
