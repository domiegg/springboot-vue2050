...
<div class="intitle">
	<ul>
    	<li><h1>共享琴房/</h1><span>New Products</span></li>
    </ul>
</div>
<div class="box p-list">
	<a href="#" class="more-products">了解更多共享琴房>></a>
    <ul>
        <c:forEach items="${syqinfangxinxi1 }" var="a">
    	<li><a href="qfxxDetail.do?id=${a.id}"><img src="${a.zhaopian}" width="299" height="304"/><span>${a.mingcheng}</span></a></li>
        </c:forEach>
