...
function gows()
{
	document.location.href="yonghusixin_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateYonghusixin.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改用户私信<input type="hidden" name="id" value="${yonghusixin.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.yonghuming.value='${yonghusixin.yonghuming}';</script>	<script language="javascript">document.form1.biaoti.value='${yonghusixin.biaoti}';</script>	<script language="javascript">document.form1.neirong.value='${yonghusixin.neirong}';</script>	<script language="javascript">document.form1.fajianren.value='${yonghusixin.fajianren}';</script>	
					 </table>
			</form>
   </body>
</html>
